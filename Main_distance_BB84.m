...
[protocolDescription,channelModel,leakageEC,parameters,solverOptions]=pmBB84WCP_decoy_distance();
...
plot(-log10(X)*10/0.2,log10(Y2),'x--',-log10(X)*10/0.2,log10(Y1),'+-');

XAXISL=xlabel('L_{AB} (km)');

YAXISL=ylabel('log_{10}R');
LEGENDL = legend('upper bound','lower bound','analytical')
% axis([0 210 -8 -2])
XAXISL.FontSize = 20;
YAXISL.FontSize = 20;
LEGENDL.FontSize = 20;

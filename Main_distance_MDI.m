...
[protocolDescription,channelModel,leakageEC,parameters,solverOptions]=MDIBB84WCP_decoy_distance();
...
plot(-log10(X)*100.0,log10(Y2),'r--',-log10(X)*100.0,log10(Y1),'b');

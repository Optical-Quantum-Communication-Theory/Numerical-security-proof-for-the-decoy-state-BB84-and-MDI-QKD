...
function [protocolDescription,channelModel,leakageEC,parameters,solverOptions] = MDIBB84WCP_decoy_alignment()
...
function parameters=setParameters()
    ...
    parameters.scan.thetaA = 0:0.0125:0.25;%0.175:0.0125:0.175; %misalignment angle between Alice-Charlie
    ...
    parameters.fixed.eta = 0.1; %channel transmittance between Alice-Charlie (half of total distance)
